    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Listar Destaques',
                    'route' => 'Listar Destaques',
                ],
                [
                    'text' => 'Listar Grupo de Produtos',
                    'route' => 'Listar GrupoProdutos',
                ],
            ],
        ],
        [
            ...
            'submenu' => [
                [
                    'text' => 'Listar Entradas',
                    'route' => 'Listar Entradas',
                ],
                [
